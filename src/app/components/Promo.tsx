    ...
    <section className="bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 shadow-lg border border-gray-200 relative overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl text-gray-900 mb-3">{T.promo.trial_title}</h3>
            <p className="text-gray-600 mb-6">{T.promo.trial_desc}</p>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 shadow-xl border-2 border-blue-400 relative overflow-hidden hover:shadow-2xl transition-shadow scale-105">
            ...
            <h3 className="text-2xl text-gray-900 mb-3">{T.promo.hardware_title}</h3>
            <p className="text-gray-600 mb-6">{T.promo.hardware_desc}</p>
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span> {T.promo.install}</li>
              <li className="mt-3 text-xs text-gray-400 italic">{T.promo.note}</li>
            </ul>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 shadow-lg border border-gray-200 relative overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl text-gray-900 mb-3 text-center">{T.promo.sub_title}</h3>
            <div className="flex items-baseline justify-center gap-1 mb-3">
              <span className="text-2xl text-cyan-600">1 500</span>
              <span className="text-gray-600">DJF / mois</span>
            </div>
            <p className="text-gray-600 mb-6 text-center">{T.promo.sub_desc}</p>
            <ul className="space-y-2 text-sm text-gray-700">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
          ...
          {/* Card - Suivi Animaux */}
          <div className="bg-gray-50 rounded-2xl p-6 shadow-lg border border-gray-200 relative overflow-hidden hover:shadow-xl transition-shadow">
